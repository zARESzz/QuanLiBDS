...
namespace QuanLy
{
    public partial class frmThongKeHang : DevExpress.XtraEditors.XtraForm
    {
        public frmThongKeHang()
        {
            InitializeComponent();
        }
        cls_ThongKe _tk;
        ...
        void loadTK()
        {
            Series _seri = new Series("Thống kê Doanh Thu", DevExpress.XtraCharts.ViewType.Line);
