...
namespace QuanLy
{
    public partial class frmThongKeCot : DevExpress.XtraEditors.XtraForm
    {
        public frmThongKeCot()
        {
            InitializeComponent();
        }
        cls_ThongKe _tk;
        ...
        void loadTK()
        {
            Series _seri = new Series("Thống kê Doanh Thu", DevExpress.XtraCharts.ViewType.Bar);
